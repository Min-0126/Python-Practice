...
# Keys are the position of the board and values are the chess piece
# Set proper pieces in their correct starting points
# Black bP -> Pawn, bN -> Knight, bB -> Bishop, bR -> Rook, bQ -> Queen, bK -> King
# White wP -> Pawn, wN -> Knight, wB -> Bishop, wR -> Rook, wQ -> Queen, wK -> King
...
# Prints a chessboard on a screent that reflects the pieces on this board.
...
def print_chessboard(board):
    ...
    for y in '87654321':
        for x in 'abcdefgh':
            # print (x, y, is_white_square)     # Debug: show coordinates in order
    ...
    # format() string method doesn't take a single argument
    # asterisk * next to the squares tells Python to pass the values in this list as individual arguments
    # which means * is equivalent to calling each object in the list
    print (BOARD_TEMPLATE.format(*squares))


def print_help():
    print('Interactive Chess Board')
    print('by Min minha0126@proton.me')
    print()
    print('Pieces:')
